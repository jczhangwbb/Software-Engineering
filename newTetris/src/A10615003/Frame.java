...
public class Frame extends JFrame {
	...
	private JLabel statusBar = new JLabel("                Gaming"); //状态现实label初始化文字
	private JLabel scoreShow = new JLabel("0               "); //状态现实label初始化文字
